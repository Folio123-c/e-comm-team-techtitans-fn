  ...
  return (
    ...
    <div className="editprofile-container">
      ...
      <div className='editpersonal-info'>
        ...
        <input type="input" value={preferredCurrency} defaultValue={preferredCurrency} onChange={(e) => setPreferredCurrency(e.target.value)}/>
        </div>
        <div className="div-form">
        <label>language:</label>
        <input type="input" value={preferredLanguage} defaultValue={preferredLanguage}  onChange={(e) => setPreferredLanguage(e.target.value)}/>
        
        </div>
        <div className="div-form">
        <label>location</label>
        <input type="input" value={location} defaultValue={location}  onChange={(e) => setLocation(e.target.value)}/>
        </div>
        <div className="div-form">
        ...
        <div className="div-form">
        <label>gender</label>
        <input type="input" value={gender} defaultValue={gender} onChange={(e) => setGender(e.target.value)}/>
        </div>
        </div>
       ...
       {status === 'loading.....' && (
              ...
              {status === 'success' && (
                <div className="success">Account saved successfully!</div>
              )}
